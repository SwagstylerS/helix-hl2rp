...
| `council` | https://github.com/tsenart/council-skill (`skills/council`) | MIT | `2040ee1` | 2026-06-16 |
...
- **council** — structured multi-perspective deliberation for hard design decisions (e.g.
  "entity vs. terminal action for detainee release"). Self-contained (SKILL.md + references/
  personas). Invoke with `/council` or "run a council on this".
